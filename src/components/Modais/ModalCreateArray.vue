          ...
          <div class="table-responsive max-height-content-detail-big p-2">
            <div class="modal-body">
              ...
              <div class="modal-footer">
                <input @click="fechouModal" type="submit" class="btn btn-primary mr-2" data-toggle="button" value="Fechar" />
                <input @click="pop" type="submit" class="btn btn-primary mr-2 fa-solid fa-plus" data-toggle="button" value="Retirar">
                <input @click="push" type="submit" class="btn btn-primary mr-2" data-toggle="button" value="Adicionar" />
            </div>
            </div>
          </div>
        <!-- </div> -->
