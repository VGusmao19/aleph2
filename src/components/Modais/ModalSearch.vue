        ...
        <div class="modal-content border-rounded-detail">
          ...
          <div class="table-responsive max-height-content-detail-big p-2">
            <div class="modal-body">
              <p class="all">Inputs:</p>
              <div class="d-flex flex-row justify-content-center">
                <input oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                  maxlength="2" class="form-control inputs mr-1" v-for="(elemento, index) in array" :key="index"
                  v-model="array[index]">

              </div>
              <p class='all'>Valor Procurado:</p>
              <div class="d-flex flex-row justify-content-center">
                <input oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                  maxlength="2" class="form-control inputs mr-1" v-model="valorProcurado"
                  placeholder="Insira o valor procurado">
            ...
            <div class="modal-footer">
              ...
              <input @click="pop" type="submit" class="btn btn-primary mr-2 fa-solid fa-plus" data-toggle="button"
                value="Retirar">
